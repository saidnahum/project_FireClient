export const largeCardSections = [
   {
      id: 1,
      title: "Extintores mejores valorados en Miguel Hidalgo - CDMX",
      snippet: "Los usuarios indicaron que éstos son los mejores extintores de la delegación a un costo accesible y puntualidad.",
      cards: [
         {
            id: 19,
   ...
   {
      id: 2,
      title: "Extintores de mejor calidad en Polanco - CDMX",
      snippet: "Los extintores disponibles cumplen los mejores estándares de calidad para una mayor segurdad.",
      cards: [
         {
            id: 22,
...
export const smallCardSections = [
   {
      id: 1,
      title: "Extintores en Miguel Hidalgo",
      cards: [
         {
            id: 1,
            image: "fe7.jpg"
   ...
   {
      id: 2,
      title: "Extintores en Chapultepec",
      cards: [
         {
            id: 13,
            image: "fe19.jpg"
